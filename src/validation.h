 ...
 */
bool ProcessNewBlock(CValidationState& state, const CChainParams& chainparams, const std::shared_ptr<const CBlock> pblock, bool fForceProcessing, bool fReceived, bool* fNewBlock) LOCKS_EXCLUDED(cs_main);
